...
4. Frontier model capabilities and access gating: current API-accessible model documentation from OpenAI, Google Gemini, Anthropic Claude, and xAI Grok. KenMatch examples use these as sandbox references only and do not claim live model execution. ([1](https://platform.openai.com/docs/models))([2](https://ai.google.dev/gemini-api/docs/models))([3](https://docs.anthropic.com/en/docs/about-claude/models/all-models))([4](https://docs.x.ai/developers/models))
