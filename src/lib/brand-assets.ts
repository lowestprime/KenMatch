export function kenmatchIconSvg({ dark = false, size = 72 }: { dark?: boolean; size?: number } = {}) {
  ...
  const foreground = dark ? "#a7fff0" : "#eafcff";
  const shell = dark ? "#020405" : "#05080d";
  const firstStop = dark ? "#7fffee" : "#89f7e8";
  ...
  <defs>
    <linearGradient id="${gradientId}" x1="8" y1="8" x2="64" y2="64" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="0.56" stop-color="#7f8dff"/>
  ...
  <circle cx="54" cy="19" r="3.8" fill="#8ffff0"/>
  <circle cx="54" cy="36" r="3.8" fill="#8ca3ff"/>
  <circle cx="54" cy="53" r="3.8" fill="#ffb16e"/>
</svg>`;
}
...
export function kenmatchAppleIconSvg() {
  ...
  <defs>
    <linearGradient id="kmGradApple" x1="20" y1="20" x2="160" y2="160" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#8ffff0"/>
      <stop offset="0.55" stop-color="#7f8dff"/>
      <stop offset="1" stop-color="#ff9b5f"/>
    </linearGradient>
  </defs>
  ...
  <path d="M56 45v90h18V104l30 31h23L88.5 94.5 124.5 47h-23L74 83V45z" fill="#dffef9"/>
  <circle cx="137" cy="47" r="9" fill="#8ffff0"/>
  <circle cx="137" cy="90" r="9" fill="#8ca3ff"/>
  <circle cx="137" cy="133" r="9" fill="#ffb16e"/>
</svg>`;
}
