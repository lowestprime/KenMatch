...
@media(max-width:360px){.site-header-inner{padding-inline:.35rem}.site-brand-row{grid-template-columns:minmax(0,1fr) auto;gap:.3rem}.site-brand{gap:.3rem}.site-brand strong{font-size:.86rem}.brand-mark{width:1.75rem;height:1.75rem}}
