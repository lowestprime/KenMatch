    ...
    <form action={formAction} className="panel category-proposal-panel">
      <div className="grid gap-2">
        ...
        <p className="text-sm leading-7 text-muted">
          New categories should make the board easier to understand, not fragment it. Strong proposals describe a repeatable class of Kens, clear public or community value, realistic evaluation criteria, and examples that could attract serious discussion or backing.
        </p>
      </div>
      ...
      <div className="form-grid form-grid-two">
        <Field name="name" label="Category name" placeholder="Example: Local Arts Tools" error={errorFor("name")} disabled={disabled || pending} />
      ...
      <div className="form-footer">
        <p className="text-xs leading-6 text-muted">Admins can approve, reject, or ask for revision. Approval adds the lane to the public board.</p>
