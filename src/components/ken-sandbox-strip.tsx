  ...
  return (
    <section className={`sandbox-strip ${compact ? "is-compact" : ""}`}>
      ...
      <p className="sandbox-disclosure" role="note">
        All dollar values, pilot user counts, and backer interest shown below are simulated outputs from provider-backed long-context workflow estimates and are <strong>not</strong> real sponsorships, investments, or production outcomes.
      </p>
